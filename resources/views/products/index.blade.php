...
<div class="d-flex align-items-center justify-content-between">
    <h1 class="mb-0">List of Tasks</h1>
    ...
    <tbody>+
        ...
        <tr>
            ...
            <td class="align-middle   ">
                ...
                <span class="badge {{$rs->product_code === 'In Progress'?'badge-primary':''}}  {{$rs->product_code === 'Done'?'badge-success':''}}   {{$rs->product_code === 'To-Do'?'badge-danger':''}} "> {{ $rs->product_code }}</span>
