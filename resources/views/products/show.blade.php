...
@section('contents')
    ...
    <div class="row">
        ...
        <div class="col mb-3">
            ...
            <input type="text" name="price" class="form-control" placeholder="Employee Name" value="{{ $product->price }}" readonly>
        </div>
    </div>
    <div class="row">
        <div class="col mb-3">
            <label class="form-label">Status</label>
            <input type="text" name="product_code" class="form-control" placeholder="Status" value="{{ $product->product_code }}" readonly>
        </div>
        <div class="col mb-3">
